...
<head>
	...
	<style>
		<?php if (function_exists('the_field')) {
			the_field('common_css', 'option');
		} ?>
	</style>
	<script>
		setTimeout(function () {
			document.body.classList.add('loaded');
			console.log('Body loaded forced by script');
		}, 1000);
	</script>
</head>
...
<body <?php body_class(); ?>>
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M7DLZK3" height="0" width="0"
