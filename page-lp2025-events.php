    ...
    <section class="lp2025-section lp2025-section-feature">
      ...
      <div class="lp2025-feature-card">
        ...
        <div class="lp2025-feature-body">
          <h3 class="lp2025-feature-title"><?php the_title(); ?></h3>

          <?php if ( $short ) : ?>
            <p class="lp2025-feature-text"><?php echo esc_html( $short ); ?></p>
          <?php endif; ?>

          <div class="lp2025-feature-meta">
            <?php if ( $date_label ) : ?>
              <span class="lp2025-feature-date"><?php echo esc_html( $date_label ); ?></span>
            <?php endif; ?>
  ...
  <section class="lp2025-section">
    ...
    <div class="lp2025-calendar-wrap">
      <div class="lp2025-calendar-head">
        <button type="button" id="lp2025-cal-prev" class="lp2025-cal-nav">‹</button>
        <div id="lp2025-cal-title" class="lp2025-cal-title"></div>
        <button type="button" id="lp2025-cal-next" class="lp2025-cal-nav">›</button>
      </div>
  ...
  while ( $events_query->have_posts() ) :
    ...
    ?>
      ...
      >
        ...
        <?php if ( $date_label ) : ?>
          <div class="lp2025-card-date"><?php echo esc_html( $date_label ); ?></div>
        <?php endif; ?>
