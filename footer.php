...
if (function_exists('the_field')) {
  the_field('common_footer', 'option');
} ?>
...
<script>
  (function () {
    function applyDelay(selector, delay) {
      ...
      sw.params.autoplay = Object.assign({}, sw.params.autoplay || {}, {
        delay: delay,
    ...
    var timer = setInterval(function () {
      tries++;
      var ok = applyDelay('.top-kv__slider', 6000); // KVを6秒
