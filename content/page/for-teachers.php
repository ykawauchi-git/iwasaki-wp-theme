<?php $pageName="page-teachers";?>
<section class="<?php echo $pageName;?>">
  <!-- 岩崎学園の想い -->
  <div class="<?php echo $pageName;?>__thought">
    <h2 class="<?php echo $pageName;?>__thought-heading page-heading"><span>岩崎学園の想い</span></h2>
    <div class="page-sec01">
      <figure class="page-sec01__thumb"><img src="<?php echo get_stylesheet_directory_uri();?>/img/page/for-teachers/bg_sec01.jpg" alt="" class="object_fit"></figure>
      <figcaption class="page-sec01__box">
  ...
  <!-- 岩崎学園の取り組み -->
  <div class="<?php echo $pageName;?>__attempt">
    <h2 class="<?php echo $pageName;?>__attempt-heading page-heading"><span>岩崎学園の取り組み</span></h2>
    <div class="page-sec02">
      <ul class="page-sec02__list">
        <!-- 01 -->
        <li class="page-sec02__item">
          <div class="page-sec02__left">
            <img class="object_fit" src="<?php echo get_stylesheet_directory_uri();?>/img/page/for-teachers/img_attempt01.jpg">
          </div>
          <div class="page-sec02__right">
            <div class="page-sec02__right-ttl">専門性と〇〇を磨く学び</div>
            <div class="page-sec02__right-txt">
              文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。<br>
        ...
        <li class="page-sec02__item">
          <div class="page-sec02__left">
            <img class="object_fit" src="<?php echo get_stylesheet_directory_uri();?>/img/page/for-teachers/img_attempt02.jpg">
          </div>
          <div class="page-sec02__right">
            <div class="page-sec02__right-ttl">学生の夢を応援する就職サポート</div>
            <div class="page-sec02__right-txt">
              文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。<br>
              文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。<br>
              文章が入ります、文章が入ります。
        ...
        <li class="page-sec02__item">
          <div class="page-sec02__left">
            <img class="object_fit" src="<?php echo get_stylesheet_directory_uri();?>/img/page/for-teachers/img_attempt03.jpg">
          </div>
          <div class="page-sec02__right">
            <div class="page-sec02__right-ttl">国家資格も目指せる資格サポート</div>
            <div class="page-sec02__right-txt">
              文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。<br>
              文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。<br>
              文章が入ります、文章が入ります。
        ...
        <li class="page-sec02__item">
          <div class="page-sec02__left">
            <img class="object_fit" src="<?php echo get_stylesheet_directory_uri();?>/img/page/for-teachers/img_attempt04.jpg">
          </div>
          <div class="page-sec02__right">
            <div class="page-sec02__right-ttl">充実の施設</div>
            <div class="page-sec02__right-txt">
              文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。<br>
              文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。<br>
              文章が入ります、文章が入ります。
        ...
        <li class="page-sec02__item">
          <div class="page-sec02__left">
            <img class="object_fit" src="<?php echo get_stylesheet_directory_uri();?>/img/page/for-teachers/img_attempt05.jpg">
          </div>
          <div class="page-sec02__right">
            <div class="page-sec02__right-ttl">安心の学費サポート</div>
            <div class="page-sec02__right-txt">
              文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。<br>
              文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。<br>
              文章が入ります、文章が入ります。
  ...
  <!-- 高校生の理解を深めるために -->
  <div class="<?php echo $pageName;?>__understanding">
      <h2 class="<?php echo $pageName;?>__understanding-heading page-heading"><span>高校生の理解を深めるために</span></h2>
      <div class="<?php echo $pageName;?>__understanding-intro">
        岩崎学園では高校生の理解を深めるために岩崎学園では高校生の理解を深めるために岩崎学園では高校生の理解を深めるために岩崎学園では高校生の理解を深めるために岩崎学園では高校生の理解を深めるために岩崎学園では高校生の理解を深めるために岩崎学園では高校生の理解を深めるために岩崎学園では高校生の理解を深めるために
      </div>
      <ul class="<?php echo $pageName;?>__understanding-list">
        <li>
          <div class="<?php echo $pageName;?>__understanding-ttl">オープンキャンパス</div>
          <div class="<?php echo $pageName;?>__understanding-concept">累計0000人参加！</div>
          <div class="<?php echo $pageName;?>__understanding-txt">
        ...
        <li>
          <div class="<?php echo $pageName;?>__understanding-ttl">学校説明会</div>
          <div class="<?php echo $pageName;?>__understanding-txt">
          文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。
          </div>
        </li>
  ...
  <!-- 各専門学校の詳細はこちら -->
  <div class="<?php echo $pageName;?>__detail">
