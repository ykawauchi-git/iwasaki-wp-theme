<div class="page-document">
  <div class="page-document__inner">
    <h1 class="page-document__heading page-heading"><span>資料請求</span></h1>
    <section class="page-document__cont">
      <h2 class="page-document__contTtl page-ttl"><span>専門学校</span></h2>
      <p class="page-document__txt">各専門学校に関する資料請求は各校のサイトから請求してください。</p>
    ...
    <section class="page-document__cont">
      <h2 class="page-document__contTtl page-ttl"><span>大学院大学</span></h2>
      <p class="page-document__txt">情報セキュリティ大学院大学に関する資料請求は以下のサイトから請求してください。</p>
      <div class="page-document__btn">
        <a href="https://www.iisec.ac.jp/toiawase/shiryou.html" target="_blank" class="btn">情報セキュリティ大学院大学</a>
      </div>
    </section>
    <section class="page-document__cont">
      <h2 class="page-document__contTtl page-ttl"><span>幼稚園</span></h2>
      <p class="page-document__txt">園児募集については各園にお問い合わせください。</p>
      <div class="page-document__btn">
        <a href="https://www.iwasaki.ac.jp/hodogaya/index.html" target="_blank" class="btn">岩崎学園付属幼稚園</a>
        <a href="https://www.iwasaki.ac.jp/isogo/index.htm" target="_blank" class="btn">岩崎学園付属磯子幼稚園</a>
      </div>
    </section>
    <section class="page-document__cont">
      <h2 class="page-document__contTtl page-ttl"><span>保育園</span></h2>
      <p class="page-document__txt">園児募集については各園にお問い合わせください。</p>
      <div class="page-document__btn">
        <a href="https://hoiku.iwasaki.ac.jp/nursery/" target="_blank" class="btn">岩崎学園東戸塚保育園</a>
        <a href="https://hoiku.iwasaki.ac.jp/kosodate/isyh/index.html" target="_blank" class="btn">岩崎学園新横浜保育園</a>
        <a href="https://hoiku.iwasaki.ac.jp/kosodate/isyh2/index.html" target="_blank" class="btn">岩崎学園新横浜第二保育園</a>
      </div>
    </section>
    <section class="page-document__cont">
      <h2 class="page-document__contTtl page-ttl"><span>児童クラブ</span></h2>
      <p class="page-document__txt">児童募集については各クラブにお問い合わせください。</p>
      <div class="page-document__btn">
        <a href="https://hoiku.iwasaki.ac.jp/gakudou/contact.html" target="_blank" class="btn multiple">岩崎学園品濃町放課後児童クラブ<br>［大地］［大空］</a>
        <a href="https://hoiku.iwasaki.ac.jp/gakudou/s_contact.html" target="_blank" class="btn">岩崎学園新横浜放課後児童クラブ</a>
      </div>
    </section>
  </div>
</div>
