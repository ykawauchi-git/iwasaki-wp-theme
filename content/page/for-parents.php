<?php $pageName="page-parents";?>
<section class="<?php echo $pageName;?>">
  <div class="<?php echo $pageName;?>__philosophy">
  <!-- 岩崎学園の想い -->
    <h2 class="<?php echo $pageName;?>__philosophy-heading page-heading"><span>教育理念</span></h2>
    <div class="<?php echo $pageName;?>__philosophy-intro">
      文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。文章が入ります、文章が入ります。
    </div>
    <a href="<?php echo home_url('/philosphy/');?>" class="page-group__contBtn">岩崎学園について知る</a>
  </div>
  <!-- 岩崎学園の学び -->
  <div class="<?php echo $pageName;?>__learning">
    <h2 class="<?php echo $pageName;?>__learning-heading page-heading"><span>岩崎学園の学び</span></h2>
    <div class="page-sec01">
      <figure class="page-sec01__thumb"><img src="<?php echo get_stylesheet_directory_uri();?>/img/page/for-parents/bg_sec01.jpg" alt="" class="object_fit"></figure>
