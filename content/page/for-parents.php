...
<section class="<?php echo $pageName;?>">
  ...
  <!-- 岩崎学園の想い -->
    ...
    <a href="<?php echo home_url('/about/');?>" class="page-group__contBtn">岩崎学園について知る</a>
  </div>
  <!-- 岩崎学園の学び -->
      ...
      <ul class="page-sec02__list">
        ...
        <li class="page-sec02__item">
          <div class="page-sec02__left">
            <img class="object_fit" src="<?php echo get_stylesheet_directory_uri();?>/img/page/for-parents/img_attempt01.jpg">
          </div>
        ...
        <li class="page-sec02__item">
          <div class="page-sec02__left">
            <img class="object_fit" src="<?php echo get_stylesheet_directory_uri();?>/img/page/for-parents/img_attempt02.jpg">
          </div>
          <div class="page-sec02__right">
        ...
        <li class="page-sec02__item">
          <div class="page-sec02__left">
            <img class="object_fit" src="<?php echo get_stylesheet_directory_uri();?>/img/page/for-parents/img_attempt03.jpg">
          </div>
          <div class="page-sec02__right">
        ...
        <li class="page-sec02__item">
          <div class="page-sec02__left">
            <img class="object_fit" src="<?php echo get_stylesheet_directory_uri();?>/img/page/for-parents/img_attempt04.jpg">
          </div>
          <div class="page-sec02__right">
