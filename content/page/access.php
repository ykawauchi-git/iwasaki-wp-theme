          ...
          <div class="<?php echo $pageName;?>__itemRow">
            ...
            <figcaption class="<?php echo $pageName;?>__itemInfo">
              <ul>
                <li>
                  <h4>所在地</h4>
                  <p>〒221-0835　横浜市神奈川区鶴屋町2-17<br>相鉄岩崎学園ビル　7F</p>
                </li>
                <li>
                  <h4>Tel</h4>
                  <p><a href="tel:045-311-5562">045-311-5562（代）</a></p>
                </li>
                <li>
                  <h4>アクセス</h4>
                  <p>横浜駅「きた西口」から徒歩1分</p>
          ...
          <div class="<?php echo $pageName;?>__itemRow">
            ...
            <figcaption class="<?php echo $pageName;?>__itemInfo">
              <ul>
                <li>
                  <h4>所在地</h4>
                  <p>〒221-0835　横浜市神奈川区鶴屋町2-17相鉄岩崎学園ビル　7F</p>
                </li>
                <li>
                  <h4>Tel</h4>
                  <p><a href="tel:045-311-5562">045-311-5562（代）</a></p>
          ...
          <div class="<?php echo $pageName;?>__itemRow">
            ...
            <figcaption class="<?php echo $pageName;?>__itemInfo">
              <ul>
                <li>
                  <h4>所在地</h4>
                  <p>〒221-0835　横浜市神奈川区鶴屋町2-14-1</p>
                </li>
                <li>
                  <h4>Tel</h4>
                  <p><a href="tel:045-311-7784">045-311-7784（代）</a></p>
                </li>
                <li>
                  <h4>アクセス</h4>
                  <p>横浜駅「きた西口」から徒歩1分</p>
          ...
          <div class="<?php echo $pageName;?>__itemRow">
            ...
            <figcaption class="<?php echo $pageName;?>__itemInfo">
              <ul>
                <li>
                  <h4>所在地</h4>
                  <p>〒220-0004　横浜市西区北幸1-2-7</p>
                </li>
                <li>
                  <h4>Tel</h4>
                  <p><a href="tel:045-311-5561">045-311-5561（代)</a></p>
                </li>
                <li>
                  <h4>アクセス</h4>
                  <p>横浜駅「きた西口」から徒歩1分</p>
          ...
          <div class="<?php echo $pageName;?>__itemRow">
            ...
            <figcaption class="<?php echo $pageName;?>__itemInfo">
              <ul>
                <li>
                  <h4>所在地</h4>
                  <p>〒240-0046　横浜市保土ヶ谷区仏向西30-17</p>
                </li>
                <li>
                  <h4>Tel</h4>
                  <p><a href="tel:045-335-2244">045-335-2244</a></p>
                </li>
                <li>
                  <h4>アクセス</h4>
                  <p>横浜駅「きた西口」から徒歩1分</p>
          ...
          <div class="<?php echo $pageName;?>__itemRow">
            ...
            <figcaption class="<?php echo $pageName;?>__itemInfo">
              <ul>
                <li>
                  <h4>所在地</h4>
                  <p>〒235-0035　横浜市磯子区田中1-11-5</p>
                </li>
                <li>
                  <h4>Tel</h4>
                  <p><a href="tel:045-772-2244">045-772-2244</a></p>
                </li>
                <li>
                  <h4>アクセス</h4>
                  <p>横浜駅「きた西口」から徒歩1分</p>
          ...
          <div class="<?php echo $pageName;?>__itemRow">
            ...
            <figcaption class="<?php echo $pageName;?>__itemInfo">
              <ul>
                <li>
                  <h4>所在地</h4>
                  <p>〒244-0801　横浜市戸塚区品濃町550-8</p>
                </li>
                <li>
                  <h4>Tel</h4>
                  <p>キャリア開発部　Tel : <a href="tel:045-311-5248">045-311-5248（直通）</a><br>
                  Tel : <a href="tel:045-311-5562">045-311-5562（代）</a></p>
                </li>
                <li>
                  <h4>アクセス</h4>
                  <p>新横浜駅「地下鉄８番出口」から徒歩7分</p>
                </li>
              </ul>
            </figcaption>
          </div>
          ...
          <div class="<?php echo $pageName;?>__itemRow">
            ...
            <figcaption class="<?php echo $pageName;?>__itemInfo">
              <ul>
                ...
                <li>
                  <h4>Tel</h4>
                  <p><a href="tel:045-474-5911">045-474-5911（代）</a></p>
                </li>
                <li>
                  <h4>アクセス</h4>
                  <p>新横浜駅「地下鉄８番出口」から徒歩7分</p>
          ...
          <div class="<?php echo $pageName;?>__itemRow">
            ...
            <figcaption class="<?php echo $pageName;?>__itemInfo">
              <ul>
                ...
                <li>
                  <h4>Tel</h4>
                  <p><a href="tel:045-826-7735">045-826-7735</a></p>
                </li>
                <li>
                  <h4>アクセス</h4>
                  <p>東戸塚駅「東口」から徒歩5分</p>
          ...
          <div class="<?php echo $pageName;?>__itemRow">
            ...
            <figcaption class="<?php echo $pageName;?>__itemInfo">
              <ul>
                <li>
                  <h4>所在地</h4>
                  <p>〒231-0862　神奈川県横浜市中区山手町254</p>
                </li>
                <li>
                  <h4>Tel</h4>
                  <p><a href="tel:045-623-2111">045-623-2111</a></p>
                </li>
                <li>
                  <h4>アクセス</h4>
                  <p>元町中華街駅６番出口から徒歩3分<br>石川町駅南口　徒歩15分</p>
                </li>
              </ul>
            </figcaption>
          </div>
